...
let stop_search = message "stop_search" (T.option T.format) "Stop"
let close_search = message "close_search" (T.option T.format) "Close"
...
let connect_more_servers = message "connect_more_servers" (T.option T.format) "Connect more\nservers"
...
let remove_old_servers = message "remove_old_servers" (T.option T.format) "Remove old\nservers"
...
let remove_all_friends = message "remove_all_friends" (T.option T.format) "Remove all friends"
let toggle_display_all_servers = message "toggle_display_all_servers" (T.option T.format) "Display all servers"
